...
import com.android.launcher3.nexus.bottombar.lawnchair.util.repeatOnAttached
import com.android.launcher3.nexus.bottombar.lawnchair.util.subscribeBlocking
...
class IcuDateTextView @JvmOverloads constructor(
    ...
    init {
        repeatOnAttached {
            val prefs = BottomBarPreferences.INSTANCE.get(context)
            val calendarFlow = prefs.calendar
...
data class DateTimeOptions(
    ...
    companion object {
        fun fromPrefs(prefs: BottomBarPreferences) = combine(
            prefs.showDate,
            prefs.showTime,
            prefs.timeFormat,
